<?php
// Story-Based Premium Landing Page for GMU Alumni Connect
// Light Theme, Apple/Stripe/Lakshya Inspired Design
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>GMU Alumni Connect — The Journey Continues</title>
    
    <!-- SEO Meta Tags -->
    <meta name="description" content="GMU Alumni Connect is the lifelong digital home for GMU graduates. Reconnect, build careers, find communities, and celebrate success globally.">
    <meta name="keywords" content="GMU, Alumni, Career, Mentorship, World Map, Reunion, Events, Lakshya, Graduates, Network">
    ...
    <style>
        ...
        * {
        ...
        /* --- STORYLINE GUIDING LINE --- */
        /* A vertical line that coordinates the entire scroll journey */
        .story-guide-line {
            position: fixed;
            left: 50px;
            top: 0;
        ...
        .shape-1 {
            width: 600px;
            height: 600px;
            background: radial-gradient(circle, rgba(96,165,250,0.3) 0%, rgba(37,99,235,0.02) 70%);
            top: -100px;
            right: -100px;
        }
        ...
        .shape-2 {
            width: 500px;
            height: 500px;
            background: radial-gradient(circle, rgba(147,197,253,0.25) 0%, rgba(96,165,250,0.01) 80%);
            bottom: -100px;
            left: -100px;
        }
        ...
        /* --- HERO: THE JOURNEY CONTINUES (SECTION 1) --- */
        .hero {
            height: 100vh;
            max-height: 100vh;
            min-height: 680px;
            ...
            padding-bottom: 0;
            position: relative;
            background: radial-gradient(circle at 10% 20%, rgba(238, 244, 255, 0.4) 0%, rgba(255, 255, 255, 0) 90%);
            overflow: hidden;
            box-sizing: border-box;
        }
        ...
        .glow-orb {
            ...
            height: 350px;
            border-radius: 50%;
            background: radial-gradient(circle, rgba(37, 99, 235, 0.12) 0%, rgba(96, 165, 250, 0.01) 70%);
            filter: blur(60px);
            pointer-events: none;
            z-index: 1;
        ...
        .orb-1 { top: 15%; left: 5%; animation-duration: 22s; }
        .orb-2 { top: 40%; right: -5%; animation-duration: 18s; }
        ...
        .live-pulse-dot {
            ...
            animation: pulse-dot-live 1.8s infinite;
        }
        ...
        .hero h1 span {
            background: linear-gradient(135deg, #2563EB 20%, #60A5FA 100%);
            -webkit-background-clip: text;
            -webkit-text-fill-color: transparent;
            font-style: italic;
        }
        ...
        .hero-stat-card {
            ...
            padding: 16px 14px;
            border-radius: 16px;
            box-shadow: inset 0 1px 0 rgba(255,255,255,0.6), 0 4px 15px rgba(0,0,0,0.01);
            transition: var(--transition-smooth);
        }
        ...
        .float-anim-1 { animation: float-up-down 5s infinite alternate ease-in-out; }
        .float-anim-2 { animation: float-left-right 4.5s infinite alternate ease-in-out; }
        .float-anim-3 { animation: float-diagonal 6s infinite alternate ease-in-out; }
        ...
        /* --- RECONNECT WITH BATCH (SECTION 2) --- */
        .reconnect-section {
            background-color: var(--bg-secondary);
        }

        .directory-mock-wrapper {
            background: #FFFFFF;
        ...
        .mock-filter-btn:hover, .mock-filter-btn.active {
            border-color: var(--color-primary);
            color: var(--color-primary);
            background-color: var(--bg-accent);
        }
        ...
        .dash-circle:nth-child(1) { background-color: #F87171; }
        .dash-circle:nth-child(2) { background-color: #FBBF24; }
        .dash-circle:nth-child(3) { background-color: #34D399; }
        ...
        /* --- MEET AGAIN THROUGH EVENTS (SECTION 5) --- */
        .events-section {
            background-color: #FFFFFF;
        }
        ...
        .events-item-left .events-dot { right: -9px; }
        .events-item-right .events-dot { left: -9px; }

        .events-item.active .events-dot {
            background-color: var(--color-primary);
        ...
        @media (max-width: 768px) {
            .events-timeline-line, .events-timeline-progress {
                left: 20px;
                transform: none;
            }
            .events-item {
            ...
            .events-item-left .events-dot, .events-item-right .events-dot {
                left: 11px;
            }
            .events-card {
                max-width: 100%;
        ...
        /* --- CELEBRATE ALUMNI SUCCESS (SECTION 6) --- */
        .showcase-section {
            background-color: var(--bg-secondary);
            width: 100%;
            height: 100vh;
        ...
        @media (max-width: 600px) {
            .showcase-container { padding: 10px 20px 30px 20px; }
            .showcase-sticky-header { padding: 0 20px; }
        }


        /* --- GMU ACROSS THE WORLD (SECTION 7) --- */
        .world-section {
            background-color: #FFFFFF;
        }
        ...
        .world-map-silhouette path:hover {
        ...
        .map-point-pulse {
            fill: var(--color-primary);
            opacity: 0.4;
            animation: pulse-dot 2.5s infinite cubic-bezier(0.215, 0.610, 0.355, 1);
        ...
        /* --- MEMORIES THAT LAST FOREVER (SECTION 8) --- */
        .gallery-section {
            background-color: var(--bg-secondary);
        }
        ...
        .lightbox-modal.active .lightbox-modal-content {
            transform: scale(1);
        }
        ...
        /* --- VOICES OF THE COMMUNITY (SECTION 9) --- */
        ...
        /* --- NEWS & ALUMNI UPDATES (SECTION 10) --- */
        .news-section {
            background-color: #FFFFFF;
        }
        ...
        .news-card:hover .news-read-link i {
        ...
        /* --- FINAL CHAPTER - THE JOURNEY CONTINUES (SECTION 11) --- */
        /* --- FINAL CHAPTER - THE JOURNEY CONTINUES (SECTION 11) --- */
        .final-chapter {
        ...
        .final-chapter .section-narrative {
            color: var(--color-light-blue);
        }
        ...
        @media (max-width: 768px) {
            .final-chapter { padding: 120px 0; }
            .final-chapter h2 { font-size: 3.5rem; }
            .final-chapter p { font-size: 1.1rem; }
        }
        ...
        .footer-grid {
            display: grid;
            grid-template-columns: 1.25fr repeat(3, 0.9fr);
            gap: 50px;
            margin-bottom: 80px;
        }
...
<body>
    ...
    <!-- --- STORYLINE SCROLL INDICATOR LINE --- -->
    <div class="story-guide-line">
        <div class="story-guide-progress" id="story-progress"></div>
    </div>
    ...
    <nav class="navbar">
        <div class="container">
            <a href="#" class="logo">
                <div class="logo-symbol">GM</div>
                <span>Alumni Connect</span>
            </a>
            
            <ul class="nav-links">
                <li><a href="#hero">Home</a></li>
                <li><a href="#reconnect">Directory</a></li>
                <li><a href="#career">Careers</a></li>
                <li><a href="#community">Groups</a></li>
                <li><a href="#events">Events</a></li>
                <li><a href="#showcase">Stories</a></li>
                <li><a href="#world">Network</a></li>
                <li><a href="#gallery">Gallery</a></li>
            </ul>

            <div class="nav-actions">
                <a href="/alumni/login.php" class="btn-login">Sign In</a>
                <a href="/alumni/register.php" class="btn-nav-primary">Join Network</a>
            </div>
    ...
    <!-- --- SECTION 1: HERO - THE JOURNEY CONTINUES --- -->
    <section class="hero" id="hero">
        ...
        <div class="container">
            <div class="hero-grid">
                ...
                <div class="hero-content">
                    <div class="hero-live-badge animate-reveal">
                        <span class="live-pulse-dot"></span>
                        <span><strong>142</strong> Graduates Connected Online Now</span>
                    </div>
                    <h1>Your GMU Journey Doesn't End <span>At Graduation</span></h1>
                    <p class="lead">Reconnect with classmates, discover career opportunities, grow your professional network, and remain part of a thriving global GMU community.</p>
                    
                    <div class="btn-group">
                        <a href="/alumni/register.php" class="btn btn-primary magnetic-btn">Join Alumni Network</a>
                        <a href="#reconnect" class="btn btn-secondary magnetic-btn">Explore Community</a>
                    </div>

                    <div class="hero-stats">
                        <div class="hero-stat-card animate-reveal">
                            <div class="hero-stat-num" data-val="25000">25,000+</div>
                            <div class="hero-stat-lbl">Alumni</div>
                        </div>
                        <div class="hero-stat-card animate-reveal">
                            <div class="hero-stat-num" data-val="40">40+</div>
                            <div class="hero-stat-lbl">Countries</div>
                        </div>
                        <div class="hero-stat-card animate-reveal">
                            <div class="hero-stat-num" data-val="500">500+</div>
                            <div class="hero-stat-lbl">Companies</div>
                        </div>
                        <div class="hero-stat-card animate-reveal">
                            <div class="hero-stat-num" data-val="100">100+</div>
                            <div class="hero-stat-lbl">Events</div>
                        </div>
                    </div>
                </div>

                <!-- Hero 3D Floating Collage -->
                <div class="hero-collage-wrapper">
                    <!-- Main Image frame -->
                    <div class="collage-main-frame parallax-item" data-speed="1.1">
                        <img src="assets/images/gallery/WhatsApp Image 2025-11-14 at 10.32.35_ddb62fc5.jpg" alt="GMU Alumni Group">
                        <div class="collage-shading"></div>
                    </div>
                    
                    <!-- Floating Card 1: Live Alumna Profile Card -->
                    <div class="collage-float-card card-profile float-anim-1">
                        <div class="float-card-avatar">
                            <img src="assets/images/medals/WhatsApp Image 2025-11-07 at 14.40.27_3afb5fa0.jpg" alt="Alumna Profile">
                        </div>
                        <div class="float-card-info">
                            <h5>Khushi Patil</h5>
                            <span class="float-card-tag">Batch of '24</span>
                            <p class="float-card-detail"><span class="pulse-dot-green"></span> Active Referral Match</p>
                        </div>
                    </div>

                    <!-- Floating Card 2: Career referral success -->
                    <div class="collage-float-card card-status float-anim-2">
                        <div class="status-icon-box"><i class="fas fa-check-circle"></i></div>
                        <div class="status-info">
                            <span class="status-label">Referral Approved</span>
                            <span class="status-company">Google Labs — Berlin</span>
                        </div>
                    </div>

                    <!-- Floating Card 3: Network Chapter location -->
                    <div class="collage-float-card card-chapter float-anim-3">
                        <div class="chapter-icon"><i class="fas fa-globe-americas"></i></div>
                        <div class="chapter-text">
                            <h6>London Chapter</h6>
                            <span>12 Active Mentors</span>
                        </div>
                    </div>
                </div>
        ...
        <div class="scroll-indicator" id="scroll-to-story">
    ...
    <!-- --- SECTION 2: RECONNECT WITH YOUR BATCH --- -->
    <section class="section reconnect-section" id="reconnect">
        <div class="container">
            
            <div class="section-header text-center">
                <span class="section-narrative">Graduation</span>
                <h2>Reconnect With Your Batch</h2>
                <p>"Years may pass, but connections remain." Re-establish ties with college friends, roommates, and teammates from across graduating classes.</p>
            </div>

            <!-- Directory mock interface -->
            <div class="directory-mock-wrapper">
                
                <!-- Mock Search -->
                <div class="mock-search-header">
                    <div class="mock-search-input-box">
                        <i class="fas fa-search"></i>
                        <input type="text" class="mock-search-input" id="directory-search" placeholder="Search classmate by name, company, or city...">
                    </div>
                    
                    <button class="mock-filter-btn active" data-filter="all">All Profiles</button>
                    <button class="mock-filter-btn" data-filter="tech">Technology</button>
                    <button class="mock-filter-btn" data-filter="mgmt">Management</button>
                    <button class="mock-filter-btn" data-filter="ent">Entrepreneurs</button>
                </div>

                <!-- Profile Grid -->
                <div class="directory-results-grid" id="directory-grid">
                    
                    <!-- Profile 1 -->
                    <div class="mock-profile-card animate-reveal" data-category="tech">
                        <div class="mock-avatar">
                            <img src="assets/images/medals/pranav.png" alt="Pranav V">
                        </div>
                        <div class="mock-profile-info">
                            <span class="mock-tag-batch">Batch of 2024</span>
                            <h4>Pranav V</h4>
                            <div class="mock-profile-meta">
                                <span><i class="fas fa-briefcase"></i> Full Stack Developer</span>
                                <span><i class="fas fa-building"></i> Digital Innovations</span>
                    ...
                    <!-- Profile 2 -->
                    <div class="mock-profile-card animate-reveal" data-category="ent">
                        <div class="mock-avatar">
                            <img src="assets/images/medals/WhatsApp Image 2025-11-07 at 14.40.27_3afb5fa0.jpg" alt="Khushi Patil">
                        </div>
                        <div class="mock-profile-info">
                            <span class="mock-tag-batch">Batch of 2024</span>
                            <h4>Khushi Patil</h4>
                            <div class="mock-profile-meta">
                                <span><i class="fas fa-briefcase"></i> Co-Founder</span>
                                <span><i class="fas fa-building"></i> Covalinx LLC</span>
                                <span><i class="fas fa-map-marker-alt"></i> Delaware, USA</span>
                            </div>
                        </div>
                    </div>

                    <!-- Profile 3 -->
                    <div class="mock-profile-card animate-reveal" data-category="mgmt">
                        <div class="mock-avatar">
                            <img src="assets/images/proud/VIRUPAKSHA GUPTA.jpeg" alt="Virupaksha Gupta">
                        </div>
                        <div class="mock-profile-info">
                            <span class="mock-tag-batch">Batch of 2006</span>
                            <h4>Virupaksha Gupta</h4>
                            <div class="mock-profile-meta">
                                <span><i class="fas fa-briefcase"></i> Vice President</span>
                                <span><i class="fas fa-building"></i> Tech Solutions Inc.</span>
                    ...
                    <div class="mock-profile-card animate-reveal" data-category="tech">
                        <div class="mock-avatar">
                            <img src="assets/images/medals/Abhishek Belagavi.png" alt="Abhishek Belagavi">
                        </div>
                        <div class="mock-profile-info">
                            <span class="mock-tag-batch">Batch of 2023</span>
                            <h4>Abhishek Belagavi</h4>
                            <div class="mock-profile-meta">
                                <span><i class="fas fa-briefcase"></i> Software Engineer</span>
                                <span><i class="fas fa-building"></i> Google Labs</span>
                    ...
                    <div class="mock-profile-card animate-reveal" data-category="ent">
                        <div class="mock-avatar">
                            <img src="assets/images/medals/WhatsApp Image 2025-11-07 at 14.40.47_5aec4de6.jpg" alt="Md Faizan Khan">
                        </div>
                        <div class="mock-profile-info">
                            <span class="mock-tag-batch">Batch of 2024</span>
                            <h4>Md Faizan Khan</h4>
                            <div class="mock-profile-meta">
                                <span><i class="fas fa-briefcase"></i> Co-Founder</span>
                                <span><i class="fas fa-building"></i> Covalinx LLC</span>
                    ...
                    <div class="mock-profile-card animate-reveal" data-category="mgmt">
                        <div class="mock-avatar">
                            <img src="assets/images/medals/Asrar S. B.png" alt="Asrar S. B">
                        </div>
                        <div class="mock-profile-info">
                            <span class="mock-tag-batch">Batch of 2023</span>
                            <h4>Asrar S. B.</h4>
                            <div class="mock-profile-meta">
                                <span><i class="fas fa-briefcase"></i> Senior Analyst</span>
                                <span><i class="fas fa-building"></i> Deloitte Corp</span>
                                <span><i class="fas fa-map-marker-alt"></i> Sydney, Australia</span>
                            </div>
                        </div>
                    </div>
    ...
    <!-- --- SECTION 3: BUILD YOUR CAREER THROUGH COMMUNITY --- -->
    <section class="section career-section" id="career">
        <div class="container">
            
            <div class="career-grid-layout">
                
                <!-- Left: Dashboard mockup -->
                <div class="dashboard-mockup parallax-item" data-speed="1.1">
                    
                    <div class="dash-header">
                        <div class="dash-circle-indicators">
                            <div class="dash-circle"></div>
                            <div class="dash-circle"></div>
                            <div class="dash-circle"></div>
                        </div>
                        <div class="dash-title"><i class="fas fa-briefcase" style="color: var(--color-primary)"></i> Alumni Career Hub</div>
                    </div>

                    <div class="dash-job-card">
                        <div class="dash-job-top">
                            <span class="dash-job-company">Covalinx LLC</span>
                            <span class="dash-job-date">2 hours ago</span>
                        </div>
                        <div class="dash-job-title">Senior Full-Stack Engineer</div>
                        <div class="dash-job-details">
                            <span><i class="fas fa-map-marker-alt"></i> Remote (US)</span>
                            <span><i class="fas fa-wallet"></i> $110k - $140k</span>
                        </div>
                    </div>

                    <div class="dash-job-card">
                        <div class="dash-job-top">
                            <span class="dash-job-company">Deloitte Corp</span>
                            <span class="dash-job-date">1 day ago</span>
                        </div>
                        <div class="dash-job-title">Business Analyst — Tech Strategy</div>
                        <div class="dash-job-details">
                            <span><i class="fas fa-map-marker-alt"></i> Sydney, Aus</span>
                            <span><i class="fas fa-clock"></i> Full-Time</span>
                        </div>
                    </div>

                    <div class="dash-interactive-panel">
                        <div class="dash-inter-left">
                            <h4>Request Referral</h4>
                            <p>Connect with Khushi Patil (Co-Founder) for this job.</p>
                        </div>
                        <button class="dash-btn" id="referral-demo-btn">Request</button>
                    </div>
                ...
                <div class="career-content">
                    <span class="section-narrative">Staying Connected</span>
                    <h2 class="animate-reveal">Build Your Career<br>Through Community</h2>
                    <p class="lead animate-reveal">"The strongest opportunities often come from people who share your journey." Leverage direct access to referrals, mentorship channels, and job boards built entirely by GMU alumni.</p>
                    
                    <div class="btn-group animate-reveal" style="margin-top: 30px;">
                        <a href="/alumni/pages/jobs.php" class="btn btn-primary magnetic-btn">Find Referrals</a>
                        <a href="/alumni/pages/mentorship.php" class="btn btn-secondary magnetic-btn">Explore Mentors</a>
                    </div>
                </div>
    ...
    <!-- --- SECTION 4: FIND YOUR COMMUNITY --- -->
    <section class="section community-section" id="community">
        <div class="container">
            
            <div class="section-header text-center">
                <span class="section-narrative">Building Careers</span>
                <h2>Find Your Community</h2>
                <p>"No matter where life takes you, there's a GMU community waiting." Join chapters and professional interest groups to share expertise.</p>
            </div>

            <div class="comm-grid">
                
                <!-- Card 1 -->
                <div class="comm-card animate-reveal">
                    <div class="comm-icon-box"><i class="fas fa-lightbulb"></i></div>
                    <h3>Entrepreneurs</h3>
                    <p>Connect with alumni founders, venture capitalists, and startups driving modern disruption and business incubation.</p>
                </div>

                <!-- Card 2 -->
                <div class="comm-card animate-reveal">
                    <div class="comm-icon-box"><i class="fas fa-venus"></i></div>
                    <h3>Women Leaders</h3>
                    <p>A specialized forum supporting, highlighting, and linking women executives, developers, and researchers from GMU.</p>
                </div>

                <!-- Card 3 -->
                <div class="comm-card animate-reveal">
                    <div class="comm-icon-box"><i class="fas fa-laptop-code"></i></div>
                    <h3>Tech Innovators</h3>
                    <p>Discuss software systems, machine learning products, cloud architectures, and digital scaling strategies with specialists.</p>
                </div>

                <!-- Card 4 -->
                <div class="comm-card animate-reveal">
                    <div class="comm-icon-box"><i class="fas fa-microscope"></i></div>
                    <h3>Researchers</h3>
                    <p>Unite with academic PhD scholars, scientific researchers, and fellows working across global universities and research labs.</p>
                </div>

                <!-- Card 5 -->
                <div class="comm-card animate-reveal">
                    <div class="comm-icon-box"><i class="fas fa-chart-line"></i></div>
                    <h3>Industry Experts</h3>
                    <p>Obtain direct domain mentorship, market guidance, product management reviews, and specialized corporate advice.</p>
                </div>

                <!-- Card 6 -->
                <div class="comm-card animate-reveal">
                    <div class="comm-icon-box"><i class="fas fa-map-marked-alt"></i></div>
                    <h3>Regional Chapters</h3>
                    <p>Stay involved with local alumni groups, dinner networks, and meetups in your home city or region globally.</p>
                </div>
    ...
    <!-- --- SECTION 5: MEET AGAIN THROUGH EVENTS --- -->
    <section class="section events-section" id="events">
        <div class="container">
            
            <div class="section-header text-center">
                <span class="section-narrative">Joining Communities</span>
                <h2>Meet Again Through Events</h2>
                <p>"Some connections are best renewed face to face." Reconnect, collaborate, and share ideas in our upcoming events.</p>
            </div>

            <!-- Timeline -->
            <div class="events-timeline">
                <div class="events-timeline-line"></div>
                <div class="events-timeline-progress" id="events-line-progress"></div>

                <!-- Event 1 -->
                <div class="events-item events-item-left animate-reveal">
                    <div class="events-dot"></div>
                    <div class="events-card">
                        <span class="events-date">Nov 24, 2026</span>
                        <h3>Global Alumni Reunion</h3>
                        <p>Our cornerstone homecoming reunion program. Tour revamped campus spaces, catch up with old batchmates, and meet faculty members.</p>
                    </div>
                </div>

                <!-- Event 2 -->
                <div class="events-item events-item-right animate-reveal">
                    <div class="events-dot"></div>
                    <div class="events-card">
                        <span class="events-date">Jan 12, 2027</span>
                        <h3>Leadership Summit</h3>
                        <p>A corporate leadership summit featuring distinguished alumni executives discussing product growth and market shifts.</p>
                    </div>
                </div>
                ...
                <div class="events-item events-item-left animate-reveal">
                    <div class="events-dot"></div>
                    <div class="events-card">
                        <span class="events-date">Mar 05, 2027</span>
                        <h3>Entrepreneurship Workshop</h3>
                        <p>Incubator panels where alumni venture capitalists evaluate tech pitches and mentor student-run startup models.</p>
                    </div>
                </div>
                ...
                <div class="events-item events-item-right animate-reveal">
                    <div class="events-dot"></div>
                    <div class="events-card">
                        <span class="events-date">May 18, 2027</span>
                        <h3>Technology Conference</h3>
                        <p>Technical talks exploring advanced AI structures, full-stack practices, and cloud technologies run by alumni tech leads.</p>
                    </div>
                </div>
                ...
                <div class="events-item events-item-left animate-reveal">
                    <div class="events-dot"></div>
                    <div class="events-card">
                        <span class="events-date">Jul 22, 2027</span>
                        <h3>Networking Meetup</h3>
                        <p>Unstructured professional networking evening designed to connect job hunters directly with recruiters within the community.</p>
                    </div>
                </div>
    ...
    <!-- --- SECTION 6: CELEBRATE ALUMNI SUCCESS --- -->
    <section class="showcase-section" id="showcase">
        <div class="showcase-sticky-header">
            <span class="section-narrative">Attending Events</span>
            <h2>Celebrate Alumni Success</h2>
            <p>"Every achievement strengthens the GMU legacy." Read inspiring success stories of our distinguished graduates globally.</p>
        </div>
            ...
            <div class="showcase-track">
                ...
                <div class="showcase-card">
                    ...
                    <div class="showcase-meta">
                        <span class="showcase-batch">Batch of 2006</span>
                    </div>
                    <h3>Virupaksha Gupta</h3>
                    <div class="showcase-position">Vice President — Fintech Operations</div>
                    <p class="showcase-desc">Led advanced financial data infrastructures. Provides regular mentoring for graduates aiming to enter fintech engineering segments.</p>
                </div>

                <!-- Card 2 -->
                <div class="showcase-card">
                    <div class="showcase-img-box">
                        <img src="assets/images/proud/Anshu.png" alt="Anshu Jha">
                    </div>
                    <div class="showcase-meta">
                        <span class="showcase-batch">Batch of 2012</span>
                    </div>
                    <h3>Anshu Jha</h3>
                    <div class="showcase-position">Founder — HealthTech Labs</div>
                    <p class="showcase-desc">Built medical diagnostics setups serving thousands. Actively funds and incubates student startup projects at the GMU Innovation Cell.</p>
                </div>

                <!-- Card 3 -->
                <div class="showcase-card">
                    <div class="showcase-img-box">
                        <img src="assets/images/proud/Manjunath.png" alt="Dr. Manjunath Prasad">
                    </div>
                    <div class="showcase-meta">
                        <span class="showcase-batch">Batch of 2008</span>
                    </div>
                    <h3>Dr. Manjunath Prasad</h3>
                    <div class="showcase-position">Senior Research Fellow</div>
                    <p class="showcase-desc">Published machine vision scientist. Leads technical collaborative studies between global research laboratories and university faculties.</p>
                </div>

                <!-- Card 4 -->
                <div class="showcase-card">
                    <div class="showcase-img-box">
                        <img src="assets/images/proud/Milind.png" alt="Milind R. K.">
                    </div>
                    <div class="showcase-meta">
                        <span class="showcase-batch">Batch of 2015</span>
                    </div>
                    <h3>Milind R. K.</h3>
                    <div class="showcase-position">Director of Engineering — Enterprise SaaS</div>
                    <p class="showcase-desc">Orchestrates large development divisions. Arranges regular hiring pipelines, technical workshops, and campus recruitments.</p>
                </div>

                <!-- Card 5 -->
                <div class="showcase-card">
                    <div class="showcase-img-box">
                        <img src="assets/images/proud/sindhu.png" alt="Sindhu Hegde">
                    </div>
                    <div class="showcase-meta">
                        <span class="showcase-batch">Batch of 2018</span>
                    </div>
                    <h3>Sindhu Hegde</h3>
                    <div class="showcase-position">Data Science Lead</div>
                    <p class="showcase-desc">Oversees retail data intelligence products. Runs training bootcamps and supports diversity initiatives in technology sectors.</p>
                </div>
    ...
    <!-- --- SECTION 7: GMU ACROSS THE WORLD --- -->
    <section class="section world-section" id="world">
        <div class="container">
            
            <div class="section-header text-center">
                <span class="section-narrative">Celebrating Success</span>
                <h2>GMU Across The World</h2>
                <p>"One university. A global network." Explore the footprint of GMU graduates building legacies globally.</p>
            </div>
            ...
            <div class="map-wrapper">
                <svg class="map-svg" viewBox="0 0 1000 500" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <!-- World Silhouette representation -->
                    <g class="world-map-silhouette" fill="#CBD5E1" stroke="#FFFFFF" stroke-width="0.55" opacity="1" transform="translate(65.577518, -120.228561) scale(1.031634, 0.771685)">
                    ...
                    <!-- Curves -->
                    <path class="map-connection-line" id="line-usa" d="M 680,260 Q 450,150 250,190"/>
                    <path class="map-connection-line" id="line-uk" d="M 680,260 Q 580,180 480,150"/>
                    <path class="map-connection-line" id="line-canada" d="M 680,260 Q 460,110 220,140"/>
                    <path class="map-connection-line" id="line-aus" d="M 680,260 Q 780,320 850,370"/>
                    <path class="map-connection-line" id="line-germany" d="M 680,260 Q 580,200 500,160"/>
                    <path class="map-connection-line" id="line-singapore" d="M 680,260 Q 710,275 740,290"/>
                    <path class="map-connection-line" id="line-uae" d="M 680,260 Q 640,245 600,230"/>
                    
                    <!-- Nodes -->
                    <!-- India -->
                    <g transform="translate(680, 260)" class="map-point-group" data-country="India" data-alumni="15,400+">
                        <circle cx="0" cy="0" r="12" class="map-point-pulse"/>
                        <circle cx="0" cy="0" r="6" class="map-point"/>
                    </g>
                    <!-- USA -->
                    <g transform="translate(250, 190)" class="map-point-group" data-country="USA" data-alumni="2,400+">
                        <circle cx="0" cy="0" r="10" class="map-point-pulse"/>
                        <circle cx="0" cy="0" r="5" class="map-point"/>
                    </g>
                    <!-- UK -->
                    <g transform="translate(480, 150)" class="map-point-group" data-country="United Kingdom" data-alumni="1,200+">
                        <circle cx="0" cy="0" r="10" class="map-point-pulse"/>
                        <circle cx="0" cy="0" r="5" class="map-point"/>
                    </g>
                    <!-- Canada -->
                    <g transform="translate(220, 140)" class="map-point-group" data-country="Canada" data-alumni="950+">
                        <circle cx="0" cy="0" r="10" class="map-point-pulse"/>
                        <circle cx="0" cy="0" r="5" class="map-point"/>
                    </g>
                    <!-- Australia -->
                    <g transform="translate(850, 370)" class="map-point-group" data-country="Australia" data-alumni="800+">
                        <circle cx="0" cy="0" r="10" class="map-point-pulse"/>
                        <circle cx="0" cy="0" r="5" class="map-point"/>
                    </g>
                    <!-- Germany -->
                    <g transform="translate(500, 160)" class="map-point-group" data-country="Germany" data-alumni="650+">
                        <circle cx="0" cy="0" r="10" class="map-point-pulse"/>
                        <circle cx="0" cy="0" r="5" class="map-point"/>
                    </g>
                    <!-- Singapore -->
                    <g transform="translate(740, 290)" class="map-point-group" data-country="Singapore" data-alumni="500+">
                        <circle cx="0" cy="0" r="10" class="map-point-pulse"/>
                        <circle cx="0" cy="0" r="5" class="map-point"/>
                    </g>
                    <!-- UAE -->
                    <g transform="translate(600, 230)" class="map-point-group" data-country="UAE" data-alumni="1,100+">
                        <circle cx="0" cy="0" r="10" class="map-point-pulse"/>
                        <circle cx="0" cy="0" r="5" class="map-point"/>
                    </g>
                </svg>
                <div class="world-tooltip" id="world-map-tooltip">India: 15,400+ Alumni</div>
            </div>

            <!-- Stats grid -->
            <div class="global-stats-row">
                <div class="global-stat-card">
                    <div class="global-stat-num">15k+</div>
                    <div class="global-stat-lbl">In India</div>
                </div>
                <div class="global-stat-card">
                    <div class="global-stat-num">3k+</div>
                    <div class="global-stat-lbl">In North America</div>
                </div>
                <div class="global-stat-card">
                    <div class="global-stat-num">2.5k+</div>
                    <div class="global-stat-lbl">In Europe</div>
                </div>
                <div class="global-stat-card">
                    <div class="global-stat-num">4.5k+</div>
                    <div class="global-stat-lbl">Rest of World</div>
                </div>
            </div>
    ...
    <!-- --- SECTION 8: MEMORIES THAT LAST FOREVER --- -->
    <section class="section gallery-section" id="gallery">
        <div class="container">
            
            <div class="section-header text-center">
                <span class="section-narrative">Global Impact</span>
                <h2>Memories That Last Forever</h2>
                <p>"Every memory becomes part of the story." Relive the moments of your student days and milestones milestones of college years.</p>
            </div>

            <div class="gallery-masonry">
                
                <div class="gallery-card animate-reveal" data-src="assets/images/gallery/WhatsApp Image 2025-11-14 at 10.32.35_2823103e.jpg">
                    <img src="assets/images/gallery/WhatsApp Image 2025-11-14 at 10.32.35_2823103e.jpg" alt="Alumni Panel Discussion">
                    <div class="gallery-hover-overlay">
                        <h4>Alumni Reunions</h4>
                        <p>Annual graduates homecoming discussions on campus panels.</p>
                    </div>
                </div>

                <div class="gallery-card animate-reveal" data-src="assets/images/gallery/WhatsApp Image 2025-11-14 at 10.52.31_202b6878.jpg">
                    <img src="assets/images/gallery/WhatsApp Image 2025-11-14 at 10.52.31_202b6878.jpg" alt="Graduation Day Celebrations">
                    <div class="gallery-hover-overlay">
                        <h4>Graduation Day</h4>
                        <p>Celebrating academic completion and launching careers.</p>
                    </div>
                </div>

                <div class="gallery-card animate-reveal" data-src="assets/images/gallery/WhatsApp Image 2025-11-14 at 10.52.33_7eef6681.jpg">
                    <img src="assets/images/gallery/WhatsApp Image 2025-11-14 at 10.52.33_7eef6681.jpg" alt="Student Life Outdoors">
                    <div class="gallery-hover-overlay">
                        <h4>Campus Life</h4>
                        <p>Daily routines, library crawls, and cafeteria chats.</p>
                    </div>
                </div>

                <div class="gallery-card animate-reveal" data-src="assets/images/gallery/WhatsApp Image 2025-11-14 at 10.52.34_511d56db.jpg">
                    <img src="assets/images/gallery/WhatsApp Image 2025-11-14 at 10.52.34_511d56db.jpg" alt="Technical Competitions">
                    <div class="gallery-hover-overlay">
                        <h4>Student Festivals</h4>
                        <p>Fostering management skills and tech innovations.</p>
                    </div>
                </div>

                <div class="gallery-card animate-reveal" data-src="assets/images/gallery/WhatsApp Image 2025-11-14 at 11.59.54_e7bc0411.jpg">
                    <img src="assets/images/gallery/WhatsApp Image 2025-11-14 at 11.59.54_e7bc0411.jpg" alt="Interactive Classroom Panels">
                    <div class="gallery-hover-overlay">
                        <h4>Workshops & Talks</h4>
                        <p>Graduates running interactive knowledge workshops.</p>
                    </div>
                </div>

                <div class="gallery-card animate-reveal" data-src="assets/images/gallery/WhatsApp Image 2025-11-14 at 12.31.42_cd6596db.jpg">
                    <img src="assets/images/gallery/WhatsApp Image 2025-11-14 at 12.31.42_cd6596db.jpg" alt="Technical Laboratory Panels">
                    <div class="gallery-hover-overlay">
                        <h4>Celebrations</h4>
                        <p>Special department milestones and festival achievements.</p>
                    </div>
                </div>
    ...
    <div class="lightbox-modal" id="lightbox">
        <span class="lightbox-modal-close" id="lightbox-close">&times;</span>
        <div class="lightbox-modal-content">
            <img src="" alt="Enlarged Preview" id="lightbox-img">
        </div>
    </div>

    <!-- --- SECTION 9: VOICES OF THE COMMUNITY --- -->
    <section class="testimonials-section" id="testimonials">
        <div class="container">
            <div class="section-header text-center">
                <span class="section-narrative">Voices Of The Community</span>
                <h2>Stories From Our Alumni</h2>
                <p>"The community is defined by the people within it." Read about the journeys and successes of our graduates.</p>
            </div>
        </div>
        ...
        <div class="testi-slider-wrapper">
            <div class="testi-track">
                ...
                <!-- Card 1 -->
                <div class="testi-slider-card">
                    <p>"GMU Alumni Connect helped me reconnect with classmates and opened doors to career opportunities I never expected. The referral network got me my current position at Google."</p>
                    <div class="testi-slider-user">
                        <div class="testi-slider-avatar">
                            <img src="assets/images/medals/pranav.png" alt="Pranav V">
                        </div>
                        <div class="testi-slider-info">
                            <h4>Pranav V</h4>
                            <span>Batch of 2024 — Full Stack Developer</span>
                        </div>
                    </div>
                </div>
                ...
                <!-- Card 2 -->
                <div class="testi-slider-card">
                    <p>"The mentorship channels in the system are exceptional. Direct networking with my seniors helped me make the career transition into machine learning products."</p>
                    <div class="testi-slider-user">
                        <div class="testi-slider-avatar">
                            <img src="assets/images/medals/Abhishek Belagavi.png" alt="Abhishek Belagavi">
                        </div>
                        <div class="testi-slider-info">
                            <h4>Abhishek Belagavi</h4>
                            <span>Batch of 2023 — Software Engineer</span>
                        </div>
                    </div>
                </div>
                ...
                <!-- Card 3 -->
                <div class="testi-slider-card">
                    <p>"Finding key talent is a startup's biggest challenge. Being able to recruit reliable, trained graduates directly through our batch network was a game changer."</p>
                    <div class="testi-slider-user">
                        <div class="testi-slider-avatar">
                            <img src="assets/images/medals/WhatsApp Image 2025-11-07 at 14.40.27_3afb5fa0.jpg" alt="Khushi Patil">
                        </div>
                        <div class="testi-slider-info">
                            <h4>Khushi Patil</h4>
                            <span>Batch of 2024 — Co-Founder, Covalinx</span>
                        </div>
                    </div>
                </div>
                ...
                <!-- Card 4 -->
                <div class="testi-slider-card">
                    <p>"An incredibly supportive network. Keeping in touch with alumni events, mentoring students, and sharing industry learnings gives a great sense of community."</p>
                    <div class="testi-slider-user">
                        <div class="testi-slider-avatar">
                            <img src="assets/images/medals/Asrar S. B.png" alt="Asrar S. B">
                        </div>
                        <div class="testi-slider-info">
                            <h4>Asrar S. B.</h4>
                            <span>Batch of 2023 — Data Analyst</span>
                        </div>
                    </div>
                </div>
    ...
    <!-- --- SECTION 10: NEWS & ALUMNI UPDATES --- -->
    <section class="section news-section" id="news">
        <div class="container">
            
            <div class="section-header text-center">
                <span class="section-narrative">Stay Informed</span>
                <h2>News & Alumni Updates</h2>
                <p>Stay up to date with university announcements, research milestones, and proud achievements of alumni members.</p>
            </div>

            <div class="news-grid">
                
                <!-- News 1 -->
                <div class="news-card animate-reveal">
                    <span class="news-cat-tag">University</span>
                    <h3>GMU Secures National Accreditation Milestones</h3>
                    <p>University ranks among leading technical institutions in recent education audit assessments.</p>
                    <div class="news-footer">
                        <span>June 08, 2026</span>
                        <a href="/alumni/pages/news.php" class="news-read-link">Read <i class="fas fa-arrow-right"></i></a>
                    </div>
                </div>

                <!-- News 2 -->
                <div class="news-card animate-reveal">
                    <span class="news-cat-tag">Achievements</span>
                    <h3>Alumna Khushi Patil Selected for VC Incubation Panel</h3>
                    <p>Covalinx co-founder invited to lead incubation panels in upcoming Global Tech Startup Summits.</p>
                    <div class="news-footer">
                ...
                <!-- News 3 -->
                <div class="news-card animate-reveal">
                    <span class="news-cat-tag">Events</span>
                    <h3>Class Reunion Schedules Announced for Fall 2026</h3>
                    <p>Registration guidelines and calendar dates launched for global batch homecoming reunions.</p>
                    <div class="news-footer">
                        <span>May 15, 2026</span>
                        <a href="/alumni/pages/events.php" class="news-read-link">Read <i class="fas fa-arrow-right"></i></a>
                    </div>
                </div>

                <!-- News 4 -->
                <div class="news-card animate-reveal">
                    <span class="news-cat-tag">Community</span>
                    <h3>Alumni Mentors Roll Out Data Analytics Training Drive</h3>
                    <p>Graduates running specialized bootcamps and webinars to train final-year students on modern cloud data.</p>
                    <div class="news-footer">
    ...
    <!-- --- SECTION 11: FINAL CHAPTER - THE JOURNEY CONTINUES --- -->
    <section class="section final-chapter" id="cta">
        <div class="container">
            <div class="final-chapter-content animate-reveal">
                <span class="section-narrative">Lifelong Alumni Journey</span>
                <h2>Graduation Was Only <span>The Beginning.</span></h2>
                <p>Join thousands of GMU graduates building careers, friendships, mentorships, and opportunities through GMU Alumni Connect.</p>
                <a href="/alumni/register.php" class="btn btn-final-cta magnetic-btn">Join GMU Alumni Connect</a>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            ...
            <div class="footer-grid">
                ...
                <div class="footer-brand">
                    ...
                    <p>Providing a lifelong digital home for GMU graduates. Networking, referrals, and growth since 2002.</p>
                </div>

                <div class="footer-col">
                    <h4>Platform</h4>
                    <ul>
                        <li><a href="/alumni/pages/directory.php">Alumni Directory</a></li>
                        <li><a href="/alumni/pages/jobs.php">Jobs Portal</a></li>
                        <li><a href="/alumni/pages/events.php">Events Calendar</a></li>
                        <li><a href="/alumni/index.php">Communities</a></li>
                    </ul>
                </div>
                ...
                <div class="footer-col">
                    <h4>University</h4>
                    <ul>
                        <li><a href="https://www.gmu.edu/" target="_blank">About GMU</a></li>
                        <li><a href="/alumni/pages/core.php">Alumni Relations</a></li>
                        <li><a href="/alumni/proud.php">Contact SPOC Team</a></li>
                    </ul>
                </div>
                ...
                <div class="footer-col">
                    <h4>Community</h4>
                    <ul>
                        <li><a href="/alumni/proud.php">Success Stories</a></li>
                        <li><a href="#world">Global Chapters</a></li>
                        <li><a href="/alumni/pages/news.php">News Corner</a></li>
                    </ul>
                </div>
            ...
            <div class="footer-bottom">
                <p>GMU Alumni Connect &copy; 2026. All rights reserved.</p>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            // --- 3. STORYLINE PROGRESS GUIDE LINE ---
            ...
            // --- 4. SECTION 2: INTERACTIVE CLASSMATE SEARCH/FILTER ---
            const searchInput = document.getElementById('directory-search');
            const filterBtns = document.querySelectorAll('.mock-filter-btn');
            const profileCards = document.querySelectorAll('.mock-profile-card');

            function filterProfiles() {
                const query = searchInput.value.toLowerCase();
                const activeFilterBtn = document.querySelector('.mock-filter-btn.active');
                const category = activeFilterBtn.getAttribute('data-filter');

                profileCards.forEach(card => {
                    const name = card.querySelector('h4').textContent.toLowerCase();
                    const company = card.querySelector('.mock-profile-meta span:nth-child(2)').textContent.toLowerCase();
                    const city = card.querySelector('.mock-profile-meta span:nth-child(3)').textContent.toLowerCase();
                    const cardCategory = card.getAttribute('data-category');

                    const matchesSearch = name.includes(query) || company.includes(query) || city.includes(query);
                    const matchesCategory = category === 'all' || cardCategory === category;

                    if (matchesSearch && matchesCategory) {
                        gsap.to(card, { opacity: 1, scale: 1, y: 0, display: 'flex', duration: 0.4, ease: "power2.out" });
                    } else {
                        gsap.to(card, { opacity: 0, scale: 0.95, y: 10, display: 'none', duration: 0.3, ease: "power2.in" });
                    }
                });
            }
            ...
            // --- 5. SECTION 3: CAREER HUB REFERRAL DEMO ---
            const referralBtn = document.getElementById('referral-demo-btn');
            referralBtn.addEventListener('click', () => {
                if (!referralBtn.classList.contains('clicked')) {
                    referralBtn.disabled = true;
                    referralBtn.innerHTML = '<i class="fas fa-spinner fa-spin"></i> Submitting...';
                    
                    setTimeout(() => {
                        referralBtn.classList.add('clicked');
                        referralBtn.innerHTML = '<i class="fas fa-check"></i> Requested';
                        referralBtn.style.background = '#10B981';
                        
                        // Show micro notifications
                        ...
                        pop.style.padding = '12px 24px';
                        pop.style.borderRadius = '10px';
                        pop.style.boxShadow = '0 10px 25px rgba(0,0,0,0.1)';
                        pop.style.fontSize = '0.9rem';
                        pop.style.fontWeight = '600';
                        pop.style.zIndex = '1000';
                        pop.innerHTML = '<i class="fas fa-check-circle" style="color: #10B981; margin-right: 8px;"></i> Referral Request Sent to Khushi Patil!';
                        document.body.appendChild(pop);
                        
                        gsap.from(pop, { y: 20, opacity: 0, duration: 0.4 });
                        setTimeout(() => {
                            gsap.to(pop, { y: -20, opacity: 0, duration: 0.4, onComplete: () => pop.remove() });
                        }, 3500);
            ...
            // Hero stats counters
            const statCards = document.querySelectorAll('.hero-stat-num');
            statCards.forEach(card => {
                const target = parseInt(card.getAttribute('data-val'));
                ScrollTrigger.create({
                    ...
                    onEnter: () => {
                        ...
                        gsap.to(obj, {
                            ...
                            ease: "power2.out",
                            onUpdate: () => {
                                let fmt = Math.floor(obj.val).toLocaleString();
                                card.textContent = fmt + '+';
                            }
                        });
                    }
                });
            ...
            parallaxItems.forEach(item => {
                const speed = parseFloat(item.getAttribute('data-speed')) || 1.2;
                gsap.to(item, {
                    yPercent: -10 * (speed - 1),
                    ease: "none",
                    scrollTrigger: {
            ...
            // --- 7. SECTION 5: EVENTS TIMELINE PROGRESS DRAW ---
            const eventItems = document.querySelectorAll('.events-item');
            gsap.to("#events-line-progress", {
                height: "100%",
                ease: "none",
                scrollTrigger: {
            ...
            // --- 8. SECTION 6: HORIZONTAL SCROLL ALUMNI SHOWCASE ---
            ...
            // --- 9. SECTION 7: GLOBAL MAP & CONNECTIONS ---
            const pins = document.querySelectorAll('.map-point-group');
            const tooltip = document.getElementById('world-map-tooltip');
            const mapWrapper = document.querySelector('.map-wrapper');

            // Map drawing curves
            gsap.fromTo('.map-connection-line', 
            ...
            pins.forEach(pin => {
                pin.addEventListener('mouseenter', () => {
                    ...
                    const alumni = pin.getAttribute('data-alumni');
                    tooltip.innerHTML = `<strong>${country}</strong>: ${alumni} Alumni`;
                    tooltip.style.opacity = '1';
                    
                    const lineId = 'line-' + country.toLowerCase().replace(' ', '-');
                    const line = document.getElementById(lineId);
                    if (line) {
                        gsap.to(line, { stroke: '#2563EB', strokeWidth: 3, opacity: 1, duration: 0.3 });
                    }
                });
                ...
                pin.addEventListener('mouseleave', () => {
                    ...
                    const line = document.getElementById(lineId);
                    if (line) {
                        gsap.to(line, { stroke: '#60A5FA', strokeWidth: 1.5, opacity: 0.7, duration: 0.3 });
                    }
                });
            });


            // --- 10. MAGNETIC ACTION BUTTONS ---
            ...
            // --- 12. SCROLL NARRATIVE INDICATOR BUTTONS ---
            document.getElementById('scroll-to-story').addEventListener('click', () => {
                lenis.scrollTo('#reconnect');
            });
